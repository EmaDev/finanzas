...
export default function Investent() {
  ...
  return (
    <div className="min-h-screen bg-black text-white p-6 relative">
      <p className="mr-1 text-5xl font-bold mb-6">Inversiones</p>
      <p className="text-xl mb-6 mt-2 font-medium">Total: $ {total.toLocaleString()}</p>
